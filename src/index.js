...
//#region Nikola logic for login to store pass/user
...
//fix this part
// fromTasksToTask(0.8726218290799542);
...
//#endregion End of Music Player

renderTasks();


let array = [{ id: 1, num: 2 }, { id: 3, num: 4 }, { id: 2, num: 7 }]
let object = {
    id: 0,
    num: 0
};
